...
// 统一的 request 拦截器
export function bindCommonRequestInterceptors(instance) {
    instance.interceptors.request.use(config => {
        return config;
    });
}
// Unified response interceptor
export function bindCommonResponseInterceptors(instance) {
...
export function createAxiosInstance(config, commonInterceptorConf = {}) {
