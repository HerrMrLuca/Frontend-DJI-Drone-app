export const CURRENT_CONFIG = {
  ...
  // http
  // TODO change IP
  baseURL: 'http://172.17.0.1:6789/', // This url must end with "/". Example: 'http://192.168.1.1:6789/'
  websocketURL: 'ws://172.17.0.1:6789/api/v1/ws', // Example: 'ws://192.168.1.1:6789/api/v1/ws'
