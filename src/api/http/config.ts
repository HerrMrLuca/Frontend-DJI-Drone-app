export const CURRENT_CONFIG = {
  ...
  // http
  baseURL: 'http://10.29.18.210:6789/', // This url must end with "/". Example: 'http://192.168.1.1:6789/'
  websocketURL: 'ws://10.29.18.210:6789/api/v1/ws', // Example: 'ws://192.168.1.1:6789/api/v1/ws'
