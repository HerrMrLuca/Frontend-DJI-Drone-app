...
export function deviceTsaUpdate () {
  ...
  function initMarker (type, name, sn, lng, lat) {
    if (AMap === undefined) {
      location.reload()
      return
    }
...
// # sourceMappingURL=use-g-map-tsa.js.map
