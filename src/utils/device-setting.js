import { DeviceSettingKeyEnum, DistanceLimitStatusEnum, ObstacleAvoidanceStatusEnum, NightLightsStateEnum } from '/@/types/device-setting'
...
// 更新formModel
export function updateDeviceSettingFormModelByOsd (deviceSettingFormModelFromOsd, deviceInfo) {
  const { device, dock, gateway } = deviceInfo || {}
